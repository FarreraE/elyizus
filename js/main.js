...
function displayerBselector(option) {
    ...
    switch (option) {
        case 1:
            sectionBDisplayer.innerHTML = "<div class=container&#32;sectionB__mainDisplay data-aos=fade><div class=row&#32;mainDisplay__top><div class=col-12&#32;col-md-9&#32;col-lg-9&#32;justify-content-end data-aos=fade-right> <h2 class=desLogLink__title> <span class=codeVSChar>&#60;</span><span class=codeVSTag>title</span><span class=codeVSChar>></span>Elyizus Portfolio <span class=codeVSChar>&#60;/</span><span class=codeVSTag>title</span><span class=codeVSChar>></span> </h2></div><div class=col-md-2&#32;col-lg-3&#32;justify-content-end data-aos=fade-left><a href=https://www.google.com/><button type=button class=btn&#32;btn-link buttonCatalog>CATALOG</button></a></div></div><div class=row&#32;sectionB__mainDisplay__bottom><p class=pComent data-aos=zoom-out>&#60;!-- The first version of this portfolio that I keep on my projects catalog because I believe that do not forget from where we come from is relevant.  WARNING: project no updated since August 2021.--></p><p class=pLinkP data-aos=fade-right> <span class=codeVSChar>&#60;</span><span class=codeVSTag>a</span><span class=codeVSClass>href</span><span class=codeVSWhite>=</span><span class=codeVSQoutes>“https://farrerae.github.io/portfolio20.7/” </span><span class=codeVSChar>></span><a class=pLinkPA href=https://farrerae.github.io/portfolio20.7/>GO TO THE WEBSITE </a><span class=codeVSChar>&#60;/</span><span class=codeVSTag>a</span><span class=codeVSChar>></span></p></div><!--                                                                 SECTION B FOOTER--><div class=row&#32;sectionB__mainDisplay__footer><div class=col-4&#32;col-md-4&#32;col-lg-2&#32;col-xl-2&#32;sectionB__mainDisplay__footerA data-aos=fade-up><img class=sectionB__mainDisplay__footerA--img src=images/logo/logo-crema.svg alt=></div><div class=col-7&#32;col-md-7&#32;offset-lg-4&#32;col-lg-4&#32;offset-xl-5&#32;col-xl-3&#32;sectionB__mainDisplay__footerB data-aos=fade-down><img class=sectionB__mainDisplay__footer--img src=images/tools/html-blanco.svg alt=html><img class=sectionB__mainDisplay__footer--img src=images/tools/bootstrap-blanco.svg alt=bootstrap><img class=sectionB__mainDisplay__footer--img src=images/tools/js-blanco.svg alt=js><img class=sectionB__mainDisplay__footer--img src=images/tools/css-blanco.svg alt=css></div></div></div></div>";
            break;
        case 2:
            sectionBDisplayer.innerHTML = "<div class=container&#32;sectionB__mainDisplay data-aos=fade><div class=row&#32;mainDisplay__top><div class=col-12&#32;col-md-9&#32;col-lg-9&#32;justify-content-end data-aos=fade-right> <h2 class=desLogLink__title> <span class=codeVSChar>&#60;</span><span class=codeVSTag>title</span><span class=codeVSChar>></span>Post Activity Form<span class=codeVSChar>&#60;/</span><span class=codeVSTag>title</span><span class=codeVSChar>></span> </h2></div><div class=col-md-2&#32;col-lg-3&#32;justify-content-end data-aos=fade-left><a href=https://www.google.com/><button type=button class=btn&#32;btn-link buttonCatalog>CATALOG</button></a></div></div><div class=row&#32;sectionB__mainDisplay__bottom><p class=pComent data-aos=zoom-out>&#60;!-- Website designed and thought to facilitate the documentation of technical activities. The PAF is interactive form that displays the necessary fields to create a report depending on the type of activity and result.--></p><p class=pLinkP data-aos=fade-right> <span class=codeVSChar>&#60;</span><span class=codeVSTag>a</span><span class=codeVSClass>href</span><span class=codeVSWhite>=</span><span class=codeVSQoutes>“https://farrerae.github.io/PAF/?”</span><span class=codeVSChar>></span><a class=pLinkPA href=https://farrerae.github.io/PAF/?>GO TO THE WEBSITE </a><span class=codeVSChar>&#60;/</span><span class=codeVSTag>a</span><span class=codeVSChar>></span></p></div><!--                                                                 SECTION B FOOTER--><div class=row&#32;sectionB__mainDisplay__footer><div class=col-4&#32;col-md-4&#32;col-lg-2&#32;col-xl-2&#32;sectionB__mainDisplay__footerA data-aos=fade-up><img class=sectionB__mainDisplay__footerA--img src=images/logo/paf-white.svg alt=></div><div class=col-7&#32;col-md-7&#32;offset-lg-4&#32;col-lg-4&#32;offset-xl-5&#32;col-xl-3&#32;sectionB__mainDisplay__footerB data-aos=fade-down><img class=sectionB__mainDisplay__footer--img src=images/tools/html-blanco.svg alt=html><img class=sectionB__mainDisplay__footer--img src=images/tools/bootstrap-blanco.svg alt=bootstrap><img class=sectionB__mainDisplay__footer--img src=images/tools/js-blanco.svg alt=js><img class=sectionB__mainDisplay__footer--img src=images/tools/css-blanco.svg alt=css></div></div></div></div>";
            break;
        case 3:
            sectionBDisplayer.innerHTML = "<div class=container&#32;sectionB__mainDisplay data-aos=fade><div class=row&#32;mainDisplay__top><div class=col-12&#32;col-md-9&#32;col-lg-9&#32;justify-content-end data-aos=fade-right> <h2 class=desLogLink__title> <span class=codeVSChar>&#60;</span><span class=codeVSTag>title</span><span class=codeVSChar>></span> Puzku <span class=codeVSChar>&#60;/</span><span class=codeVSTag>title</span><span class=codeVSChar>></span> </h2></div><div class=col-md-2&#32;col-lg-3&#32;justify-content-end data-aos=fade-left><a href=https://www.google.com/><button type=button class=btn&#32;btn-link buttonCatalog>CATALOG</button></a></div></div><div class=row&#32;sectionB__mainDisplay__bottom><p class=pComent data-aos=zoom-out>&#60;!-- This project is a mathematical game that combined a sliding block puzzle and Sudoku on the same board. The objective is to organize the pieces along routes to establish an end-configuration where the numbers should not be repeated in the same row, column, or sub-grid.--></p><p class=pLinkP data-aos=fade-right> <span class=codeVSChar>&#60;</span><span class=codeVSTag>a</span><span class=codeVSClass>href</span><span class=codeVSWhite>=</span><span class=codeVSQoutes>“https://farrerae.github.io/PUZKU/”</span><span class=codeVSChar>></span><a class=pLinkPA href=https://farrerae.github.io/PUZKU/>GO TO THE WEBSITE </a><span class=codeVSChar>&#60;/</span><span class=codeVSTag>a</span><span class=codeVSChar>></span></p></div><!--                                                                 SECTION B FOOTER--><div class=row&#32;sectionB__mainDisplay__footer><div class=col-4&#32;col-md-4&#32;col-lg-2&#32;col-xl-2&#32;sectionB__mainDisplay__footerA data-aos=fade-up><img class=sectionB__mainDisplay__footerA--img src=images/logo/logo-puzku.svg alt=></div><div class=col-7&#32;col-md-7&#32;offset-lg-4&#32;col-lg-4&#32;offset-xl-5&#32;col-xl-3&#32;sectionB__mainDisplay__footerB data-aos=fade-down><img class=sectionB__mainDisplay__footer--img src=images/tools/html-blanco.svg alt=html><img class=sectionB__mainDisplay__footer--img src=images/tools/bootstrap-blanco.svg alt=bootstrap><img class=sectionB__mainDisplay__footer--img src=images/tools/js-blanco.svg alt=js><img class=sectionB__mainDisplay__footer--img src=images/tools/css-blanco.svg alt=css></div></div></div></div>";
            break;
        case 4:
            sectionBDisplayer.innerHTML = "<div class=container&#32;sectionB__mainDisplay data-aos=fade><div class=row&#32;mainDisplay__top><div class=col-12&#32;col-md-9&#32;col-lg-9&#32;justify-content-end data-aos=fade-right> <h2 class=desLogLink__title> <span class=codeVSChar>&#60;</span><span class=codeVSTag>title</span><span class=codeVSChar>></span>Amagi<span class=codeVSChar>&#60;/</span><span class=codeVSTag>title</span><span class=codeVSChar>></span> </h2></div><div class=col-md-2&#32;col-lg-3&#32;justify-content-end data-aos=fade-left><a href=https://www.google.com/><button type=button class=btn&#32;btn-link buttonCatalog>CATALOG</button></a></div></div><div class=row&#32;sectionB__mainDisplay__bottom><p class=pComent data-aos=zoom-out>&#60;!-- Restaurant web site description --></p><p class=pLinkP data-aos=fade-right> <span class=codeVSChar>&#60;</span><span class=codeVSTag>a</span><span class=codeVSClass>href</span><span class=codeVSWhite>=</span><span class=codeVSQoutes>“Comming Soon”</span><span class=codeVSChar>></span><a class=pLinkPA href=https://www.youtube.com/>GO TO THE WEBSITE </a><span class=codeVSChar>&#60;/</span><span class=codeVSTag>a</span><span class=codeVSChar>></span></p></div><!--                                                                 SECTION B FOOTER--><div class=row&#32;sectionB__mainDisplay__footer><div class=col-4&#32;col-md-4&#32;col-lg-2&#32;col-xl-2&#32;sectionB__mainDisplay__footerA data-aos=fade-up><img class=sectionB__mainDisplay__footerA--img src=images/logo/logo-amagi.svg alt=></div><div class=col-7&#32;col-md-7&#32;offset-lg-4&#32;col-lg-4&#32;offset-xl-5&#32;col-xl-3&#32;sectionB__mainDisplay__footerB data-aos=fade-down><img class=sectionB__mainDisplay__footer--img src=images/tools/html-blanco.svg alt=html><img class=sectionB__mainDisplay__footer--img src=images/tools/bootstrap-blanco.svg alt=bootstrap><img class=sectionB__mainDisplay__footer--img src=images/tools/js-blanco.svg alt=js><img class=sectionB__mainDisplay__footer--img src=images/tools/css-blanco.svg alt=css></div></div></div></div>";
            break;
    }
...
function displayerAselector(option) {
    ...
    switch (option) {
        ...
        case 3:
            sectionADisplayer.innerHTML = "<span class=pComent> <h2 data-aos=flip-down>THE BIG TIME!</h2></span> <p data-aos=flip-up><span class=pComent>- Fullstack program :</span> Coder House, In progress.<span class=pComent><br>- Technical Computer Engineering (2 years):</span> Seneca College, Canada 2016.<span class=pComent> <br>- Pathway Program (TOEFL):</span> ILAC, Canada 2014-2015. <span class=pComent> <br>- Diploma in Sound Engineering:</span> Audioplace, Venezuela 2014. <span class=pComent>  <br> - Systems Engineering (2 years): </span> Metropolitan University, Venezuela 2010</p>";
